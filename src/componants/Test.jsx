...
const Test = () => {
  ...
  const result1 = () =>{
   ...
   return  <>
    ...
    <br/>
    <br/>
    <h4 className='num'>physical - {(((phr-7)/28)*100).toFixed(2)} </h4>
    <progress id="file1" value={(((phr-7)/28)*100)} max="100">{phr} </progress>
    <br/>
    <h4 className='num'>social - {(((sr-3)/12)*100).toFixed(2)}</h4>
    <progress id="file2" value={(((sr-3)/12)*100)} max="100">{sr} </progress>
    <br/>
    <h4 className='num'>psychological - {(((psr-6)/24)*100).toFixed(2)}</h4>
    <progress id="file3" value={(((psr-6)/24)*100)} max="100">{psr}  </progress>
    <br/>
    <h4 className='num'>environmental - {(((er-4)/16)*100).toFixed(2)}</h4>
    <progress id="file4" value={(((er-4)/16)*100)} max="100">{er}  </progress>
